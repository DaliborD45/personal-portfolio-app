...
const styleValuesBasedOnDevice = {
  XXL: {
    ...
    h2: { fontSize: "62px", lineHeight: "1.5" },
  ...
  XL: {
    ...
    h2: { fontSize: "52px", lineHeight: "1.5" },
  ...
  L: {
    ...
    h2: { fontSize: "42px", lineHeight: "1.5" },
  ...
  M: {
    ...
    h2: { fontSize: "42px", lineHeight: "1.3" },
...
const headingStyle = css<{
  ...
  @media ${device.XXL} {
    font-size: ${(props) =>
      styleValuesBasedOnDevice["XXL"][props.variant].fontSize};
    line-height: ${(props) =>
      styleValuesBasedOnDevice["XXL"][props.variant].lineHeight};
  }
  @media ${device.XL} {
    font-size: ${(props) =>
